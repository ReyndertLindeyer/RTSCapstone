...
void AUNIT_Prism::BeginPlay()
{
	Super::BeginPlay();

	if (setPlayerOwner != nullptr)
		InitializeEntity(Cast<II_Player>(setPlayerOwner), "Prism Cannon", startingHealth);
...
// Called every frame
void AUNIT_Prism::Tick(float DeltaTime)
{
...
void AUNIT_Prism::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
...
void AUNIT_Prism::SetSelection(bool state, II_Player* inPlayer)
{
	isSelected = state;
